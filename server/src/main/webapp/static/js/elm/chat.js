...
Elm.Chat = Elm.Chat || {};
Elm.Chat.Action = Elm.Chat.Action || {};
Elm.Chat.Action.make = function (_elm) {
   "use strict";
   _elm.Chat = _elm.Chat || {};
   _elm.Chat.Action = _elm.Chat.Action || {};
   if (_elm.Chat.Action.values)
   return _elm.Chat.Action.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "Chat.Action",
   $Basics = Elm.Basics.make(_elm),
   ...
   var MqttSend = function (a) {
      return {ctor: "MqttSend"
             ,_0: a};
   };
   var MqttConnect = function (a) {
      return {ctor: "MqttConnect"
             ,_0: a};
   };
   var RequestMqtt = {ctor: "RequestMqtt"};
   var Post = function (a) {
      return {ctor: "Post",_0: a};
   };
   var PostFormInput = function (a) {
      return {ctor: "PostFormInput"
             ,_0: a};
   };
   var PostArrived = function (a) {
      return {ctor: "PostArrived"
             ,_0: a};
   };
   var Connected = {ctor: "Connected"};
   var ResponseError = function (a) {
      return {ctor: "ResponseError"
             ,_0: a};
   };
   var MqttInfoResponse = function (a) {
      return {ctor: "MqttInfoResponse"
             ,_0: a};
   };
   var Connect = {ctor: "Connect"};
   var ConnectionFormInput = function (a) {
      return {ctor: "ConnectionFormInput"
             ,_0: a};
   };
   var MqttInfo = F5(function (a,
   b,
   c,
   d,
   e) {
   ...
   _elm.Chat.Action.values = {_op: _op
                             ,MqttInfo: MqttInfo
...
Elm.Chat = Elm.Chat || {};
Elm.Chat.Main = Elm.Chat.Main || {};
Elm.Chat.Main.make = function (_elm) {
   "use strict";
   _elm.Chat = _elm.Chat || {};
   _elm.Chat.Main = _elm.Chat.Main || {};
   if (_elm.Chat.Main.values)
   ...
   $Basics = Elm.Basics.make(_elm),
   $Chat$Action = Elm.Chat.Action.make(_elm),
   $Chat$Model = Elm.Chat.Model.make(_elm),
   $Chat$Task = Elm.Chat.Task.make(_elm),
   $Chat$Update = Elm.Chat.Update.make(_elm),
   $Chat$View = Elm.Chat.View.make(_elm),
   $Html = Elm.Html.make(_elm),
   $Json$Encode = Elm.Json.Encode.make(_elm),
   $Lib$App = Elm.Lib.App.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $Task = Elm.Task.make(_elm);
   var toElm = Elm.Native.Port.make(_elm).inboundSignal("toElm",
   "Json.Encode.Value",
   function (v) {
      return v;
   });
   var toJs = $Signal.mailbox($Json$Encode.$null);
   var fromElm = Elm.Native.Port.make(_elm).outboundSignal("fromElm",
   function (v) {
      return v;
   },
   toJs.signal);
   var app = $Lib$App.create({_: {}
                             ,model: $Chat$Model.init
   ...
   var taskContext = {_: {}
                     ,address: app.address
                     ,js: toJs.address};
   var execTask = Elm.Native.Task.make(_elm).performSignal("execTask",
   $Signal.mergeMany(_L.fromArray([A2($Lib$App.execTask,
                                  $Chat$Task.exec(taskContext),
                                  app.task)
                                  ,A2($Signal.map,
                                  $Chat$Task.execJs(taskContext),
                                  toElm)])));
...
Elm.Chat = Elm.Chat || {};
Elm.Chat.Model = Elm.Chat.Model || {};
Elm.Chat.Model.make = function (_elm) {
   "use strict";
   _elm.Chat = _elm.Chat || {};
   _elm.Chat.Model = _elm.Chat.Model || {};
   if (_elm.Chat.Model.values)
   ...
   var PostForm = function (a) {
      return {_: {},content: a};
   };
   var ConnectedState = F3(function (a,
   b,
   c) {
      return {_: {}
             ,form: b
   ...
   var ConnectingState = function (a) {
      return {_: {},name: a};
   };
   var ConnectionForm = function (a) {
      return {_: {},name: a};
   };
   var NotConnectedState = function (a) {
      return {_: {},form: a};
   };
   ...
   var Connecting = function (a) {
      return {ctor: "Connecting"
             ,_0: a};
   };
   var NotConnected = function (a) {
      return {ctor: "NotConnected"
             ,_0: a};
   };
   var init = NotConnected({_: {}
                           ,form: {_: {},name: ""}});
...
Elm.Chat = Elm.Chat || {};
Elm.Chat.Task = Elm.Chat.Task || {};
Elm.Chat.Task.make = function (_elm) {
   "use strict";
   _elm.Chat = _elm.Chat || {};
   _elm.Chat.Task = _elm.Chat.Task || {};
   if (_elm.Chat.Task.values)
   return _elm.Chat.Task.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "Chat.Task",
   $Basics = Elm.Basics.make(_elm),
   $Chat$Action = Elm.Chat.Action.make(_elm),
   $Chat$Model = Elm.Chat.Model.make(_elm),
   $Http = Elm.Http.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm),
   $Task = Elm.Task.make(_elm);
   var wrap = F3(function (w,
   key,
   value) {
      return $Json$Encode.object(_L.fromArray([w
                                              ,{ctor: "_Tuple2"
                                               ,_0: key
                                               ,_1: value}]));
   });
   var withType = function (type_) {
      return A2(wrap,
      {ctor: "_Tuple2"
      ,_0: "type"
   ...
   var postToString = function (post) {
      return $Json$Encode.encode(0)($Json$Encode.object(_L.fromArray([{ctor: "_Tuple2"
                                                                      ,_0: "user"
                                                                      ,_1: $Json$Encode.string(post.user)}
                                                                     ,{ctor: "_Tuple2"
                                                                      ,_0: "time"
                                                                      ,_1: $Json$Encode.$float(post.time)}
                                                                     ,{ctor: "_Tuple2"
                                                                      ,_0: "content"
                                                                      ,_1: $Json$Encode.string(post.content)}])));
   };
   var mqttInfoToJValue = function (info) {
      return $Json$Encode.object(_L.fromArray([{ctor: "_Tuple2"
                                               ,_0: "host"
                                               ,_1: $Json$Encode.string(info.host)}
                                              ,{ctor: "_Tuple2"
                                               ,_0: "port"
                                               ,_1: $Json$Encode.$int(info.port_)}
                                              ,{ctor: "_Tuple2"
                                               ,_0: "clientId"
                                               ,_1: $Json$Encode.string(info.clientId)}
                                              ,{ctor: "_Tuple2"
                                               ,_0: "username"
                                               ,_1: $Json$Encode.string(info.username)}
                                              ,{ctor: "_Tuple2"
                                               ,_0: "password"
                                               ,_1: $Json$Encode.string(info.password)}]));
   };
   var jsonStringToPost = function () {
      var toPost = F3(function (user,
      time,
      content) {
         return {_: {}
                ,content: content
      ...
      var dec = A4($Json$Decode.object3,
      toPost,
      A2($Json$Decode._op[":="],
      "user",
      $Json$Decode.string),
      ...
      $Json$Decode.string));
      return function ($) {
         return $Result.toMaybe($Json$Decode.decodeString(dec)($));
      };
   }();
   var jsDecoder = A2($Json$Decode.andThen,
   A2($Json$Decode.at,
   _L.fromArray(["type"]),
   $Json$Decode.string),
   function (t) {
      return function () {
         switch (t)
         {case "connected":
            return $Json$Decode.succeed($Maybe.Just($Chat$Action.Connected));
            case "messageArrived":
            return A2($Json$Decode.andThen,
              A2($Json$Decode.at,
              _L.fromArray(["message"]),
              $Json$Decode.string),
              function (m) {
                 return function () {
                    var _v1 = jsonStringToPost(m);
                    switch (_v1.ctor)
                    {case "Just":
                       return $Json$Decode.succeed($Maybe.Just($Chat$Action.PostArrived(_v1._0)));
                       case "Nothing":
         ...
         return $Json$Decode.fail("invalid type");
      }();
   });
   var mqttInfoDecoder = function () {
      var toMqttInfo = F5(function (host,
      port_,
      clientId,
      username,
      password) {
   ...
   var execJs = F2(function (context,
   value) {
      return function () {
   ...
   var exec = F2(function (context,
   task) {
      return function () {
         switch (task.ctor)
         {case "MqttConnect":
            return $Signal.send(context.js)(withType("connect")(A2(wrap,
              {ctor: "_Tuple2"
              ,_0: "destination"
              ,_1: $Json$Encode.string("/chat")},
              "info")(mqttInfoToJValue(task._0))));
            case "MqttSend":
            return $Signal.send(context.js)(withType("send")(A2(wrap,
              {ctor: "_Tuple2"
              ,_0: "destination"
              ,_1: $Json$Encode.string("/chat")},
              "message")($Json$Encode.string(postToString(task._0)))));
            case "RequestMqtt":
            return function () {
                 var task = $Task.mapError($Chat$Action.ResponseError)($Task.map($Chat$Action.MqttInfoResponse)(A2($Http.get,
                 mqttInfoDecoder,
                 "/api/mqtt")));
                 return A2($Task.onError,
                 A2($Task.andThen,
                 task,
                 $Signal.send(context.address)),
                 $Signal.send(context.address));
              }();}
         _U.badCase($moduleName,
         "between lines 23 and 41");
      }();
   });
...
Elm.Chat = Elm.Chat || {};
Elm.Chat.Update = Elm.Chat.Update || {};
Elm.Chat.Update.make = function (_elm) {
   "use strict";
   _elm.Chat = _elm.Chat || {};
   _elm.Chat.Update = _elm.Chat.Update || {};
   if (_elm.Chat.Update.values)
   return _elm.Chat.Update.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
         ...
         {case "_Tuple2":
            switch (_v0._0.ctor)
              {case "Connected":
                 switch (_v0._1.ctor)
                   {case "Post":
                      return _U.eq(_v0._0._0.form.content,
                        "") ? {ctor: "_Tuple2"
                              ,_0: model
                              ,_1: $Maybe.Nothing} : function () {
                           var next = $Chat$Model.Connected(_U.replace([["form"
                                                                        ,{_: {}
                                                                         ,content: ""}]],
                           _v0._0._0));
                           var post = {_: {}
                                      ,content: _v0._0._0.form.content
                                      ,time: _v0._1._0
                                      ,user: _v0._0._0.name};
                           var task = $Maybe.Just($Chat$Action.MqttSend(post));
                           return {ctor: "_Tuple2"
                                  ,_0: next
                                  ,_1: task};
                        }();
                      case "PostArrived":
                      return function () {
                           var task = $Maybe.Nothing;
                           var next = $Chat$Model.Connected(_U.replace([["posts"
                                                                        ,A2($List._op["::"],
                                                                        _v0._1._0,
                                                                        _v0._0._0.posts)]],
                           _v0._0._0));
                 ...
                 switch (_v0._1.ctor)
                   {case "Connected":
                      return function () {
                           var task = $Maybe.Nothing;
                           var next = $Chat$Model.Connected({_: {}
                                                            ,form: {_: {}
                                                                   ,content: ""}
                                                            ,name: _v0._0._0.name
                                                            ,posts: _L.fromArray([])});
                      ...
                      case "MqttInfoResponse":
                      return function () {
                           var task = $Maybe.Just($Chat$Action.MqttConnect(_v0._1._0));
                           var next = $Chat$Model.Connecting(_v0._0._0);
                           return {ctor: "_Tuple2"
                                  ,_0: next
                                  ,_1: task};
                        }();
                      ...
                      return function () {
                           var task = $Maybe.Nothing;
                           var next = $Chat$Model.NotConnected({_: {}
                                                               ,form: {_: {}
                                                                      ,name: ""}});
                           return {ctor: "_Tuple2"
                                  ,_0: next
                 ...
                 switch (_v0._1.ctor)
                   {case "Connect":
                      return _U.eq(_v0._0._0.form.name,
                        "") ? {ctor: "_Tuple2"
                              ,_0: model
                              ,_1: $Maybe.Nothing} : function () {
                           var task = $Maybe.Just($Chat$Action.RequestMqtt);
                           var next = $Chat$Model.Connecting({_: {}
                                                             ,name: _v0._0._0.form.name});
                           return {ctor: "_Tuple2"
                                  ,_0: next
                                  ,_1: task};
                        }();
                      case "ConnectionFormInput":
                      return function () {
                           var task = $Maybe.Nothing;
                           var next = $Chat$Model.NotConnected(_U.replace([["form"
                                                                           ,_v0._1._0(_v0._0._0.form)]],
                           _v0._0._0));
                           return {ctor: "_Tuple2"
                                  ,_0: next
   ...
   _elm.Chat.Update.values = {_op: _op
                             ,update: update};
   return _elm.Chat.Update.values;
};
Elm.Chat = Elm.Chat || {};
Elm.Chat.View = Elm.Chat.View || {};
Elm.Chat.View.make = function (_elm) {
   "use strict";
   _elm.Chat = _elm.Chat || {};
   _elm.Chat.View = _elm.Chat.View || {};
   if (_elm.Chat.View.values)
   return _elm.Chat.View.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "Chat.View",
   $Basics = Elm.Basics.make(_elm),
   $Chat$Action = Elm.Chat.Action.make(_elm),
   $Chat$Model = Elm.Chat.Model.make(_elm),
   ...
   var timeToString = function ($) {
      return $Date$Format.format("%Y/%m/%d %H:%M:%S")($Date.fromTime($));
   };
      ...
      return function () {
         var toTr = function (post) {
            ...
            _L.fromArray([A2($Html.td,
                         _L.fromArray([]),
                         _L.fromArray([$Html.text(post.user)]))
                         ,A2($Html.td,
                         _L.fromArray([]),
                         _L.fromArray([$Html.text(post.content)]))
                         ,A2($Html.td,
                         _L.fromArray([]),
                         _L.fromArray([$Html.text(timeToString(post.time))]))]));
         };
         ...
         _L.fromArray([A2($Html.thead,
                      ...
                      ,$Html.tbody(_L.fromArray([]))(A2($List.map,
                      toTr,
                      posts))]));
      }();
   };
   var post = F2(function (address,
   model) {
      return A2($Html.div,
      _L.fromArray([$Html$Attributes.style(_L.fromArray([{ctor: "_Tuple2"
                                                         ,_0: "display"
      ...
      _L.fromArray([A2($Html.div,
                   ...
                   _L.fromArray([$Html$Attributes.$class("form-control")
                                ,$Html$Attributes.value(model.form.content)
                                ...
                                function (x) {
                                   ...
                                   address,
                                   $Chat$Action.PostFormInput(function (form) {
                   ...
                   _L.fromArray([$Html$Attributes.$class("btn btn-success")
                                ...
                                "click",
                                A2($Json$Decode.at,
                                _L.fromArray(["timeStamp"]),
                                $Json$Decode.$float),
                                function ($) {
                                   return $Signal.message(address)($Chat$Action.Post($));
                                })]),
                   _L.fromArray([$Html.text("Post")]))]))]));
   });
   ...
   var userInput = function (address) {
      return A2($Html.div,
      _L.fromArray([$Html$Attributes.style(_L.fromArray([{ctor: "_Tuple2"
                                                         ,_0: "display"
                                                         ,_1: "flex"}]))]),
      _L.fromArray([A2($Html.div,
                   ...
                   _L.fromArray([$Html$Attributes.$class("form-control")
                                ...
                                function (x) {
                                   return A2($Signal.message,
                                   address,
                                   $Chat$Action.ConnectionFormInput(function (form) {
                   ...
                   _L.fromArray([$Html$Attributes.$class("btn btn-success")
                                ...
                                address,
                                $Chat$Action.Connect)]),
                   _L.fromArray([$Html.text("Connect")]))]))]));
   };
      ...
      return function () {
         var children = function () {
            ...
            {case "Connected":
               ...
               return _L.fromArray([A2($Html.div,
                 _L.fromArray([$Html$Attributes.$class("row")]),
                 _L.fromArray([$Html.text("connecting...")]))]);
               case "NotConnected":
               return _L.fromArray([A2($Html.div,
                 _L.fromArray([$Html$Attributes.$class("row")]),
                 _L.fromArray([userInput(address)]))]);}
            _U.badCase($moduleName,
            "between lines 20 and 48");
         }();
         return A2($Html.div,
...
Elm.Lib = Elm.Lib || {};
Elm.Lib.App = Elm.Lib.App || {};
Elm.Lib.App.make = function (_elm) {
   "use strict";
   _elm.Lib = _elm.Lib || {};
   _elm.Lib.App = _elm.Lib.App || {};
   if (_elm.Lib.App.values)
   return _elm.Lib.App.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm),
   $Task = Elm.Task.make(_elm);
   var execTask = function (f) {
      return $Signal.map(function ($) {
         return $Maybe.withDefault($Task.succeed({ctor: "_Tuple0"}))($Maybe.map(f)($));
      });
   };
   var createActions = function ($default) {
      return function () {
         var actions = $Signal.mailbox($default);
         return {_: {}
                ,address: A2($Signal.forwardTo,
                actions.address,
                $Maybe.Just)
   ...
   var create = function (option) {
      return function () {
         var actions = createActions($Maybe.Nothing);
         var modelWithTask = A3($Signal.foldp,
         F2(function (_v0,_v1) {
            return function () {
               switch (_v1.ctor)
               {case "_Tuple2":
                  return function () {
                       switch (_v0.ctor)
                       {case "Just":
                          return A2(option.update,
                            _v0._0,
                            _v1._0);}
                       _U.badCase($moduleName,
                       "on line 48, column 37 to 63");
                    }();}
               _U.badCase($moduleName,
               "on line 48, column 37 to 63");
            }();
         ...
         $Basics.fst,
         modelWithTask);
         var task = A2($Signal.map,
         $Basics.snd,
         modelWithTask);
         var main = A2($Signal.map,
         option.view(actions.address),
         model);
         return {_: {}
   ...
   var Actions = F2(function (a,
   b) {
      return {_: {}
             ,address: a
             ,signal: b};
   });
   var AppOption = F3(function (a,
   b,
   c) {
      return {_: {}
             ,model: a
